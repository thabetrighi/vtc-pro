...
use App\Orchid\Layouts\Settings\SettingTabs;
...
class SettingFieldsScreen extends Screen
{
    /**
            ...
            Layout::rows([
                ...
                Group::make([
                    Input::make('email')
                        ->type('email')
                        ->title('Email')
                        ->value('bootstrap@setting.com')
                        ->placeholder('setting@setting.com')
