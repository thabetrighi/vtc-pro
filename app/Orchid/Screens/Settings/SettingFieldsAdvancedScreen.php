...
use App\Orchid\Layouts\Settings\SettingElements;
...
class SettingFieldsAdvancedScreen extends Screen
{
    /**
    ...
    {
        return 'Settings for creating a wide variety of forms.';
    }
    ...
    public function layout(): iterable
    {
        return [
            ...
            Layout::rows([
                ...
                Input::make('raw_file')
                    ->type('file')
                    ->title('File input setting')
                    ->horizontal(),

                Input::make('raw_files')
                    ->type('file')
                    ->title('Multiple files input setting')
                    ->multiple()
                    ->horizontal(),
